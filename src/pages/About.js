  ...
  render(){
    ...
    <div>
      <div className = "row" style = {{marginLeft: "5vw", marginRight: "5vw"}}>
        ...
        <button className = "" type = "button" onClick = {() => this.setState({isOpen: !this.state.isOpen})}>LISTEN NOW</button>
        </div>
        <Modal className = "aboutPop" overlayClassName = "aboutOverlay" isOpen = {this.state.isOpen} onRequestClose = {() => this.setState({isOpen: !this.state.isOpen})}>
          ...
          <a className = "l6 row d-block" href = "https://open.spotify.com/artist/6dZMYil8Wj3zvMFS5hoA8U">
